...
from botbuilder.core import (
    ...
    TurnContext,
    BotFrameworkAdapter, MemoryStorage, ConversationState, UserState,
)
...
from bots.DialogBot import DialogBot
...
from helpers.proactive_messages import parse_proactive_message
...
DIALOG = WelcomeDialog(USER_STATE, RECOGNIZER)
...
# Triggerata dalla richiesta HTTP inviata dalla function app
...
APP.router.add_get("/api/notify", notify)  # usata dalla function app
